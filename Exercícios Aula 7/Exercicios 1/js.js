...
var posit = 10
console.log(`${posit} é um número positivo!`)

var neg = -15
console.log(`${neg} é um número negativo!`)

var dec = 12.3
console.log(`${dec} é um número decimal!`)
...
console.log('Hoje é dia de din din :)')}

var nome = 'Fernando'
var nome1 = 'Sant Anna'
var nome2 = 'Borba'
console.log(`Meu nome completo é ${`${nome} ${nome1} ${nome2}`}`)

var nome = "Clara"; //retorna o nome
console.log(nome)

var nome ="Clara";
console.log(nome, sobrenome); // retorna erro, pois, o sobrenome não está definido
